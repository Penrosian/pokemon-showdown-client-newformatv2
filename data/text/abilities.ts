export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	easypickings: {
		name: "Easy Pickings",
		desc: "(Currently no effect) The first move used by this Pokemon after switching in will deal double damage.",
		shortDesc: "Currently no effect.",
	},
	eartheater: {
		name: "Earth Eater",
	...
	ghastlyfeeling: {
		name: "Ghastly Feeling",
		desc: "(Currently Shadow Tag) The opposing Pokemon can't escape, including Ghost-Type Pokemon.",
		shortDesc: "The opposing Pokemon can't escape.",
	},
	gluttony: {
		name: "Gluttony",
	...
	overwhelmingpresence: {
		...
		desc: "When this Pokemon enters the field, all opposing Pokemon's special attack stat is lowered by 1 stage.",
		shortDesc: "Lower opponent's special attack on switch in.",
	},
	owntempo: {
		name: "Own Tempo",
	...
	unseenfist: {
		name: "Unseen Fist",
		shortDesc: "This Pokemon's contact moves ignore the target's protection.",
		gen8: {
			shortDesc: "This Pokemon's contact moves ignore the target's protection, except Max Guard."
		}
	},
	unwaveringprowess: {
		name: "Unwavering Prowess",
		desc: "(No Current Effect) This Pokemon's moves damage the target based on the other defensive stat if it would be stronger.",
		shortDesc: "No current effect.",
	},
	vesselofruin: {
		name: "Vessel of Ruin",
	...
	weakpoint: {
		name: "Weakpoint",
		desc: "This Pokemon's moves deal damage based on the targets other defensive stat if it would be stronger. This Pokemon's moves ignore immunities.",
		shortDesc: "Effect of Unwavering Prowess, plus this Pokemon's moves ignore immunities.",
	},
	wellbakedbody: {
