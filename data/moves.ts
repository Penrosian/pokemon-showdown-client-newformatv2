...
export const Moves: {[moveid: string]: MoveData} = {
	...
	burstingrampage: {
		...
		basePower: 95,
		category: "Physical",
		name: "Bursting Rampage",
		pp: 5,
		priority: 0,
		flags: {protect: 1},
		//effects gonna go here
		secondary: null,
		target: "normal",
		type: "Dragon",
	},
	...
	dynamicpunch: {
		...
		pp: 5,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, punch: 1, recharge: 1},
		self: {
			volatileStatus: 'mustrecharge',
		},
		volatileStatus: 'confusion',
	...
	mistyexplosion: {
		...
		onBasePower(basePower, source) {
			if (this.field.isTerrain('mistyterrain') && source.isGrounded()) {
				...
				return this.chainModify(1.66666666666666666);
			}
		},
		secondary: null,
		target: "allAdjacent",
	...
	skyattack: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, distance: 1, nosleeptalk: 1, failinstruct: 1, contact: 1},
		critRatio: 2,
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
	...
	vengefultransformation: {
		...
		priority: 0,
		flags: {},
		//No this is not a switch out move
		//This is for when we need to select a Pokemon to /kill
		selfSwitch: true,
		secondary: null,
		target: "self",
		type: "Dark",
	...
	zapcannon: {
		...
		pp: 5,
		priority: 0,
		flags: {bullet: 1, protect: 1, mirror: 1, recharge: 1},
		self: {
			volatileStatus: 'mustrecharge',
		},
		status: 'par',
